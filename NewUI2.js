...
//CORE:
    ...
    createSetting('RadonHourChallenge', 'Challenge list for U2 portal', 'Automatically portal into this challenge when using helium per hour or custom autoportal.', 'dropdown', 'None', ['None', 'Bublé', 'Melt', 'Quagmire'], "Core");
