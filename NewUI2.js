...
//CORE:
    ...
    createSetting('RadonHourChallenge', 'Challenge list for U2 portal', 'Automatically portal into this challenge when using helium per hour or custom autoportal.', 'dropdown', 'None', ['None', 'Bublé', 'Melt'], "Core");
...
function automationMenuInit() {
    ...
    newContainer.setAttribute("onmouseover", 'tooltip(\"Health to Damage ratio\", \"customText\", event, \"This displays the current mode that Automaps is in. H:D ratio means estimated enemy health vs your current damage.<p><br><b>MapAtZone: </b>\" + game.options.menu.mapAtZone.enabled + \" at: \" + ((game.global.universe == 1)?(game.options.menu.mapAtZone.setZone[0]):(game.options.menu.mapAtZone.setZoneU2[0])) + \"<br><b>H:D ratio = </b>\" + newHDratio + \"<br><b>HP ratio = </b>\" + healthRatio + \"<br>\" +\"<br><b>Map vars: </b><br>shouldDoMaps: \" + shouldDoMaps + \"<br>needPrestige: \" + needPrestige + \"<br>doMaxMapBonus: \" + doMaxMapBonus + \"<br>needToVoid: \" + needToVoid + \"<br>doVoids: \" + doVoids + \"<br>\")');
