...
//CORE:
    ...
    createSetting('BetterAutoFight', ['Better AutoFight OFF', 'Better Auto Fight 1'], 'Will automatically handle fighting. WARNING: If you autoportal with BetterAutoFight disabled, the game sits there doing nothing until you click FIGHT. (not good for afk) ', 'multitoggle', 1, null, "Core");
    ...
    createSetting('RadonHourChallenge', 'Challenge list for U2 portal', 'Automatically portal into this challenge when using helium per hour or custom autoportal.', 'dropdown', 'None', ['None', 'Bublé', 'Melt', 'Quagmire', 'Archaeology', 'Insanity', 'Nurture', 'Alchemy'], "Core");
...
//AutoMaps + VoidMaps settings:
    ...
    createSetting('SpireLimit', 'Min Spire for AT', 'Spires below this value are treated as normal zones. e.g. Set to 3 and most AT Spire-specific settings only take effect on Spire III and later.<br>Does not work with Run Bionic Before Spire.', 'value', 1, null, "Maps");
