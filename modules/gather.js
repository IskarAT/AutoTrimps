...
function manualLabor2() {
    ...
    //Traps and Trimps:
    if(trapTrimpsOK && (breedingTrimps < 50000 || trapperTrapUntilFull || watchJumpstartTraps) && game.buildings.Trap.owned == 0 && canAffordBuilding('Trap')) {
        //safeBuyBuilding returns false if item is already in queue
        if(!safeBuyBuilding('Trap'))
            setGather('buildings');
        return;
    ...
    // Do not attempt to build manualy
