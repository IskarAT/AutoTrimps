...
function betterAutoFight() {
    ...
    var targetBreed = 0; // Default instant autofighting
    if (!(game.global.world < 230 || getCurrentEnemy().name == "Liquimp")) targetBreed = (game.global.spireActive ? 45 : 3); // So this is a first hot-fix to Spire instakills, as well as enforcing at least x seconds worth of breeding
